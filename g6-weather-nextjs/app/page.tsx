...
export default function Home() {
  ...
  return (
<main className="sunset-bg min-h-screen flex flex-col items-center px-4 py-8 sm:px-6 sm:py-12">      <h1 className="mb-6 text-center text-2xl font-bold text-gray-800 sm:mb-8 sm:text-3xl">
        App del Clima - G6
      </h1>
